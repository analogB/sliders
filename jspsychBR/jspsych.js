 ...
 *
 * BR Added factorialNoShuffle and repeatNoShuffle modules
 **/
...
jsPsych.randomization = (function() {
  ...
  module.repeatNoShuffle = function(array, repetitions, unpack) {
  ...
  module.factorial = function(factors, repetitions, unpack) {
    ...
    module.factorialNoShuffle = function(factors, repetitions, unpack) {
    ...
    repetitions = (typeof repetitions === 'undefined') ? 1 : repetitions;
    var with_repetitions = module.repeatNoShuffle(factor_combinations, repetitions, unpack);
